...
export default function AdminSidebar({ siteTitle }: { siteTitle: string }) {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 py-6 border-b border-[#2A2A30]">
        <Link href="/admin" className="text-[#F0F0F2] text-lg font-semibold tracking-tight">
          {siteTitle}
        </Link>
      ...
      {/* Bottom section */}
      <div className="px-3 py-4 border-t border-[#2A2A30] space-y-1">
        <Link
          href="/"
          target="_blank"
  ...
  return (
    <>
      ...
      {/* Sidebar - desktop */}
      <aside className="hidden lg:block w-60 shrink-0 bg-[#141416] border-r border-[#2A2A30] h-screen sticky top-0">
        {sidebarContent}
      </aside>
    </>
  );
